        ...
        return http.securityMatcher("/users/**")
                ...
                .authorizeHttpRequests(request ->
                        request.requestMatchers(HttpMethod.POST,"/users").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, UserResource.USERS + UserResource.FORGET_PASSWORD).permitAll()
                                .requestMatchers(HttpMethod.POST, UserResource.USERS + UserResource.FORGET_PASSWORD).permitAll()
                                .requestMatchers(HttpMethod.GET, UserResource.USERS + UserResource.FORGET_PASSWORD_TOKEN).permitAll()
                                .requestMatchers(HttpMethod.POST, UserResource.USERS + UserResource.FORGET_PASSWORD_TOKEN).permitAll()
